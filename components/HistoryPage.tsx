...
const HistoryPage: React.FC<HistoryPageProps> = ({ history }) => (
    <section className="max-w-6xl mx-auto animate-fade-in-slide-up">
        <h2 className="text-3xl font-bold text-center mb-12"><span className="bg-gradient-to-r from-gray-700 to-gray-900 dark:from-stone-100 dark:to-stone-300 bg-clip-text text-transparent">Prompt History</span></h2>
        {history.length === 0 ? (
