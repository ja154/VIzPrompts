 ...
 * The video is fully buffered into a data URL before processing to avoid potential streaming issues.
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (event: ProgressEvent<FileReader>) => {
      if (typeof event.target?.result !== 'string') {
        return reject(new Error("FileReader did not return a string for the video file."));
      }
